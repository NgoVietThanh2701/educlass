...
export class AssessmentAttemptController {
  ...
  start(
    ...
    return this.assessmentAttemptService.startAttempt(studentId, dto);
  }
  ...
  submit(
    ...
    return this.assessmentAttemptService.submitAttempt(id, studentId);
  }
  ...
  syncAnswers(
    ...
    return this.assessmentAttemptService.syncAnswers(id, studentId, dto);
  }
  ...
  findOne(
    ...
    return this.assessmentAttemptService.findOne(id, userId, role);
  }
  ...
  findAllByTeacher(@CurrentUser('id') userId: string, @Query() query: QueryAttemptDto) {
    return this.assessmentAttemptService.findAllByTeacher(userId, query);
  }
  ...
  findMyAttempts(@CurrentUser('id') userId: string, @Query() query: QueryAttemptDto) {
    return this.assessmentAttemptService.findMyAttempts(userId, query);
  }
}
